    ...
    def __init__(self):
        ...
        self.FEATURES = {
            "auto_start_camera": {
                ...
                "description": "Automatically start the camera when Sevue is launched.",
                "category": "General",
                "configurable": True,
            },
            "minimize_to_tray": {
                ...
                "description": "When enabled, minimizing the window will send it to the system tray instead of the taskbar.",
                "category": "General",
                "configurable": True,
            },
            "close_to_tray": {
                ...
                "state": "CLOSE_TO_TRAY",
                "label": "Close to Tray",
                "description": "When enabled, closing the window will send it to the system tray instead of exiting the application.",
                "category": "General",
                "configurable": True,
            },
            "start_minimized": {
                ...
                "description": "When enabled, Sevue will start minimized to the system tray.",
                "category": "General",
                "configurable": True,
            },
            "start_on_boot": {
                ...
                "description": "When enabled, Sevue will automatically start when you log into your computer.",
                "category": "General",
                "configurable": True,
            ...
            "flip_camera": {
                ...
                "state": "FLIP_VIDEO",
                "label": "Flip Camera",
                "description": "Flip the camera feed horizontally. This is often used to create a mirror effect.",
            ...
            "flip_subtitles": {
                ...
                "description": "Reverse text direction when looking into a mirror.",
            ...
            "flip_hands": {
                ...
                "state": "FLIP_HANDS",
                "label": "Flip Hands",
                "description": "Flip hand landmarks horizontally. This is useful when using a flipped camera feed to ensure hand movements are interpreted correctly.",
